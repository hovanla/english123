      ...
      <section className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[1.3fr_.7fr] lg:py-16">
        ...
        <aside className="rounded-[2rem] border border-[#dbe7df] bg-white p-7 shadow-sm sm:p-9">
          ...
          <div className="mt-7 space-y-4 text-sm">
            {["32 lesson theo đúng mục Từ vựng & Mẫu câu", "150 hoạt động nhìn–nghe–đoán", "4 từ mỗi bài từ vựng", "Ôn tập cách quãng 1–3–7–14 ngày"].map((item) => <p key={item} className="flex gap-3"><span className="text-emerald-600">✓</span>{item}</p>)}
          </div>
        </aside>
      </section>
