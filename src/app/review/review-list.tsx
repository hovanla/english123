...
export default function ReviewList() {
  const [items, setItems] = useState<Item[]>([]); const [upcoming, setUpcoming] = useState<Item[]>([]); const [loading, setLoading] = useState(true); const [answer, setAnswer] = useState<Record<string, unknown>>({}); const [message, setMessage] = useState(""); const [revealed, setRevealed] = useState(false);
