...
export default async function DashboardPage() {
  ...
  return <main className="min-h-screen bg-[#f5f8f5] text-[#163129]">
    ...
    <div className="mx-auto max-w-6xl px-4 py-5 sm:py-6">
      ...
      <Link href="/pronunciation" className="mt-4 flex min-h-14 items-center justify-between rounded-2xl bg-violet-100 px-4 py-3 text-violet-950"><span><strong>🎙 Học phát âm</strong><span className="mt-1 block text-xs">12 bài · Khẩu hình, nghe phân biệt và luyện đọc</span></span><span aria-hidden="true">→</span></Link>
