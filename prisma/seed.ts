...
async function main() {
  ...
  console.log(`Đã tạo ${gradeShells.length} cấp lớp, 13 khóa học và ${units.length} unit (20 unit Mầm non, 20 unit Lớp 1–5, 16 unit Lớp 6–8, 10 unit Lớp 9 và 48 unit Lớp 10–12).`);
}
